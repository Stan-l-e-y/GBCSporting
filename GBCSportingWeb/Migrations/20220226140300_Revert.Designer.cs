...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220226140300_Revert")]
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 2, 26, 9, 2, 59, 814, DateTimeKind.Local).AddTicks(9254),
                            DateOpened = new DateTime(2022, 2, 26, 9, 2, 59, 814, DateTimeKind.Local).AddTicks(9252),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 2, 26, 9, 2, 59, 814, DateTimeKind.Local).AddTicks(9257),
                            DateOpened = new DateTime(2022, 2, 26, 9, 2, 59, 814, DateTimeKind.Local).AddTicks(9255),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 2, 26, 9, 2, 59, 814, DateTimeKind.Local).AddTicks(9201),
                        ...
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 2, 26, 9, 2, 59, 814, DateTimeKind.Local).AddTicks(9231),
