...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220324220656_SeedDataForRegistrati")]
    partial class SeedDataForRegistrati
    {
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 3, 24, 18, 6, 56, 145, DateTimeKind.Local).AddTicks(9147),
                            DateOpened = new DateTime(2022, 3, 24, 18, 6, 56, 145, DateTimeKind.Local).AddTicks(9145),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 3, 24, 18, 6, 56, 145, DateTimeKind.Local).AddTicks(9151),
                            DateOpened = new DateTime(2022, 3, 24, 18, 6, 56, 145, DateTimeKind.Local).AddTicks(9149),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 3, 24, 18, 6, 56, 145, DateTimeKind.Local).AddTicks(9117),
                        ...
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 3, 24, 18, 6, 56, 145, DateTimeKind.Local).AddTicks(9120),
                            YearlyPrice = 50.979999999999997
                        });
                });

            modelBuilder.Entity("GBCSportingWeb.Models.Registration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
