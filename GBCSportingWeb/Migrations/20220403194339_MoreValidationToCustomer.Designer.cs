...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220403194339_MoreValidationToCustomer")]
    partial class MoreValidationToCustomer
    {
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 4, 3, 15, 43, 39, 96, DateTimeKind.Local).AddTicks(8582),
                            DateOpened = new DateTime(2022, 4, 3, 15, 43, 39, 96, DateTimeKind.Local).AddTicks(8581),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 4, 3, 15, 43, 39, 96, DateTimeKind.Local).AddTicks(8585),
                            DateOpened = new DateTime(2022, 4, 3, 15, 43, 39, 96, DateTimeKind.Local).AddTicks(8584),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 4, 3, 15, 43, 39, 96, DateTimeKind.Local).AddTicks(8556),
                        ...
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 4, 3, 15, 43, 39, 96, DateTimeKind.Local).AddTicks(8559),
