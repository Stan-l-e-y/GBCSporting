...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220226154545_Revert4")]
    partial class Revert4
    {
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 2, 26, 10, 45, 45, 339, DateTimeKind.Local).AddTicks(9539),
                            DateOpened = new DateTime(2022, 2, 26, 10, 45, 45, 339, DateTimeKind.Local).AddTicks(9537),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 2, 26, 10, 45, 45, 339, DateTimeKind.Local).AddTicks(9543),
                            DateOpened = new DateTime(2022, 2, 26, 10, 45, 45, 339, DateTimeKind.Local).AddTicks(9542),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 2, 26, 10, 45, 45, 339, DateTimeKind.Local).AddTicks(9483),
                        ...
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 2, 26, 10, 45, 45, 339, DateTimeKind.Local).AddTicks(9517),
