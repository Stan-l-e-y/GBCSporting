...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220226043542_Incident_model")]
    partial class Incident_model
    {
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 2, 25, 23, 35, 42, 575, DateTimeKind.Local).AddTicks(6287),
                            DateOpened = new DateTime(2022, 2, 25, 23, 35, 42, 575, DateTimeKind.Local).AddTicks(6286),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 2, 25, 23, 35, 42, 575, DateTimeKind.Local).AddTicks(6291),
                            DateOpened = new DateTime(2022, 2, 25, 23, 35, 42, 575, DateTimeKind.Local).AddTicks(6289),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 2, 25, 23, 35, 42, 575, DateTimeKind.Local).AddTicks(6238),
                        ...
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 2, 25, 23, 35, 42, 575, DateTimeKind.Local).AddTicks(6265),
