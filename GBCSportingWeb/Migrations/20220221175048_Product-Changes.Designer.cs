...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220221175048_Product-Changes")]
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 2, 21, 14, 50, 48, 578, DateTimeKind.Local).AddTicks(9587),
                            DateOpened = new DateTime(2022, 2, 21, 14, 50, 48, 578, DateTimeKind.Local).AddTicks(9586),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 2, 21, 14, 50, 48, 578, DateTimeKind.Local).AddTicks(9589),
                            DateOpened = new DateTime(2022, 2, 21, 14, 50, 48, 578, DateTimeKind.Local).AddTicks(9589),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            ProductName = "Thom",
                            ReleaseDate = new DateTime(2022, 2, 21, 14, 50, 48, 578, DateTimeKind.Local).AddTicks(9550),
                        ...
                        new
                        {
                            ProductId = 2,
                            ProductName = "Edward",
                            ReleaseDate = new DateTime(2022, 2, 21, 14, 50, 48, 578, DateTimeKind.Local).AddTicks(9561),
                            YearlyPrice = 115.98
                        });
                });
