...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220216183621_AddProductModel")]
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 2, 16, 15, 36, 20, 726, DateTimeKind.Local).AddTicks(2288),
                            DateOpened = new DateTime(2022, 2, 16, 15, 36, 20, 726, DateTimeKind.Local).AddTicks(2286),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 2, 16, 15, 36, 20, 726, DateTimeKind.Local).AddTicks(2290),
                            DateOpened = new DateTime(2022, 2, 16, 15, 36, 20, 726, DateTimeKind.Local).AddTicks(2290),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
