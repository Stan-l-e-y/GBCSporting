...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220226154343_Revert2")]
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 2, 26, 10, 43, 43, 391, DateTimeKind.Local).AddTicks(7257),
                            DateOpened = new DateTime(2022, 2, 26, 10, 43, 43, 391, DateTimeKind.Local).AddTicks(7255),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 2, 26, 10, 43, 43, 391, DateTimeKind.Local).AddTicks(7260),
                            DateOpened = new DateTime(2022, 2, 26, 10, 43, 43, 391, DateTimeKind.Local).AddTicks(7258),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 2, 26, 10, 43, 43, 391, DateTimeKind.Local).AddTicks(7202),
                        ...
                        new
                        {
                            ...
                            ReleaseDate = new DateTime(2022, 2, 26, 10, 43, 43, 391, DateTimeKind.Local).AddTicks(7233),
