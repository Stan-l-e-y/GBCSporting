...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220221175922_Product-Changes.3")]
    partial class ProductChanges3
    {
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 2, 21, 14, 59, 21, 745, DateTimeKind.Local).AddTicks(7013),
                            DateOpened = new DateTime(2022, 2, 21, 14, 59, 21, 745, DateTimeKind.Local).AddTicks(7011),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 2, 21, 14, 59, 21, 745, DateTimeKind.Local).AddTicks(7014),
                            DateOpened = new DateTime(2022, 2, 21, 14, 59, 21, 745, DateTimeKind.Local).AddTicks(7014),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            ProductName = "Thom",
                            ReleaseDate = new DateTime(2022, 2, 21, 14, 59, 21, 745, DateTimeKind.Local).AddTicks(6972),
                        ...
                        new
                        {
                            ProductId = 2,
                            ProductName = "Edward",
                            ReleaseDate = new DateTime(2022, 2, 21, 14, 59, 21, 745, DateTimeKind.Local).AddTicks(6984),
                            YearlyPrice = 115.98
                        });
                });
