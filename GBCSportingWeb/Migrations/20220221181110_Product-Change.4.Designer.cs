...
namespace GBCSportingWeb.Migrations
{
    ...
    [Migration("20220221181110_Product-Change.4")]
    partial class ProductChange4
    {
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IncidentId = 1,
                            CustomerId = 1,
                            DateClosed = new DateTime(2022, 2, 21, 15, 11, 9, 949, DateTimeKind.Local).AddTicks(5991),
                            DateOpened = new DateTime(2022, 2, 21, 15, 11, 9, 949, DateTimeKind.Local).AddTicks(5990),
                            ProductId = 1,
                            TechnicianId = 1,
                            Title = "Problem!!"
                        },
                        new
                        {
                            IncidentId = 2,
                            CustomerId = 2,
                            DateClosed = new DateTime(2022, 2, 21, 15, 11, 9, 949, DateTimeKind.Local).AddTicks(5993),
                            DateOpened = new DateTime(2022, 2, 21, 15, 11, 9, 949, DateTimeKind.Local).AddTicks(5992),
                            ProductId = 2,
                            TechnicianId = 2,
                            Title = "Another one!!!"
                        });
            ...
            modelBuilder.Entity("GBCSportingWeb.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            ProductName = "Thom",
                            ReleaseDate = new DateTime(2022, 2, 21, 15, 11, 9, 949, DateTimeKind.Local).AddTicks(5934),
                        ...
                        new
                        {
                            ProductId = 2,
                            ProductName = "Edward",
                            ReleaseDate = new DateTime(2022, 2, 21, 15, 11, 9, 949, DateTimeKind.Local).AddTicks(5949),
                            YearlyPrice = 115.98
                        });
                });
